package com.halcyon.layout.common
{
   ...
   public class HalcyonIconLabelHorizontallyButton extends HalcyonCanvas
   {
      ...
      public function HalcyonIconLabelHorizontallyButton(reference:DisplayObjectContainer)
      {
